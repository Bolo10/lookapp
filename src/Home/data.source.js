...
export const Nav00DataSource = {
  ...
  logo: {
    ...
    children: 'https://blog.ida.cl/wp-content/uploads/sites/5/2020/04/tamano-redes-blog-655x470.png',
  },
  Menu: {
  ...
  childWrapper: {
    ...
    children: [
      ...
      },
      {
        ...
        children: (
          <span>
            <p>La innovación en el presente</p>
          </span>
        ),
      },
      {
...
export const Feature40DataSource = {
  ...
  titleWrapper: {
    ...
    children: [
      {
        name: 'title',
        children: 'Vestidor Digital',
        className: 'title-h1',
      },
      {
        name: 'content',
        className: 'title-content',
        children: 'Pruebate la ropa que desees en tu tienda favorita.',
      },
    ],
  },
  img: {
    ...
    children: [
      {
        ...
        title: { className: 'content6-title', children: 'Variedad' },
        content: {
          className: 'content6-content',
          children:
            'Puedes encontrar cualquier prenda disponible en la app。',
        },
      },
      {
        name: 'block1',
        ...
        title: { className: 'content6-title', children: 'Fácil de usar' },
        content: {
          className: 'content6-content',
          children:
            'Estamos trabajando para que el uso sea muy intuitivo e interactivo.',
        },
      },
      {
        name: 'block2',
        ...
        title: { className: 'content6-title', children: 'Rápido' },
        content: {
          className: 'content6-content',
          children:
            'Podras acceder a realidad virtual en un solo toque para ver como te ves.',
        },
      },
    ],
  },
        ...
        children: {
          ...
          content: {
            ...
            children: (
              <span>
                50 Prendas <br />
                3 primeros meses a（$50）<br />
                Asistencia remota 24/7 - 365<br />
      ...
      },
      {
        ...
        children: {
          ...
          content: {
            ...
            children: (
              <span>
                Prendas Ilimitadas<br />
                3 primeros meses（50$）<br />
                Asistencia remota 24/7 - 365<br />
                Asistencia precencial 24/7 - 365<br />
                Mantenimiento de equipos<br />
                Desarrollo de nuevas prendas<br />
              </span>
            ),
          },
          line: { className: 'pricing1-line' },
                ...
                <span>
                  <span>
                    <span>
                      <span>
                        <p>
                          Lookapp fue creado con el fin de innovar el método de
                          interacción de tus clientes con tu tienda.
                        </p>
                      </span>
                    </span>
                  </span>
        ...
        titleWrapper: {
          children: [
            ...
            },
            {
              ...
              children: (
                <span>
                  <p>Cofounder, Strategy Marketing</p>
                </span>
              ),
            },
            {
        ...
        titleWrapper: {
          children: [
            ...
            },
            {
              ...
              children: (
                <span>
                  <p>Cofounder, Research &amp; Analysis</p>
                </span>
              ),
            },
            {
